...
TEST_CASE("Dispatch compute_tile_ranges shader", "[gpu]") {
  ...
  uniforms.image_height = kImageHeight;
  uniforms.image_width = kImageWidth;
  uniforms.grid_height = kGridHeight;
  ...
  tests::require_valid_tile_ranges(actual_tile_ranges, sorted_keys, kGridWidth, kGridHeight);
