...
TEST_CASE("Dispatch cumsum single-pass utility shader", "[gpu]") {
  ...
  const auto fixture_root = nlrc::vksplat::tests::fixture_dir("D_cumsum_single_pass");
  const auto golden_root = nlrc::vksplat::tests::golden_dir("D_cumsum_single_pass");
  ...
  const auto initial_output = nlrc::vksplat::tests::load_fixture_buffer<std::int32_t>(fixture_root, manifest, "output");
  const auto block_sums = nlrc::vksplat::tests::load_fixture_buffer<std::int32_t>(fixture_root, manifest, "block_sums");
  ...
  const auto expected = nlrc::vksplat::tests::load_fixture_buffer<std::int32_t>(golden_root, golden_manifest, "output");
...
TEST_CASE("Dispatch sum utility shader", "[gpu]") {
  ...
  const auto fixture_root = nlrc::vksplat::tests::fixture_dir("D_sum");
  const auto golden_root = nlrc::vksplat::tests::golden_dir("D_sum");
...
TEST_CASE("Dispatch where utility shader", "[gpu]") {
  ...
  const auto fixture_root = nlrc::vksplat::tests::fixture_dir("D_where");
  const auto golden_root = nlrc::vksplat::tests::golden_dir("D_where");
